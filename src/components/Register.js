...
class Register extends React.Component {
    ...
    handleSubmit = (e) => {
        e.preventDefault();
        if (this.state.form.userName === "Admin" && this.state.form.email === "Admin@gmail.com" && this.state.form.password === "Admin@infy20" && this.state.form.confirmPassword === "Admin@infy20") {
            this.setState({ successMessage: "Account created successfully" })
            this.props.history.push("/home")
            console.log("Account created successfully")
        }
        else {
            this.setState({ errorMessage: "Account already created" })
        }
    }
